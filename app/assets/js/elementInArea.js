...
(function(x1, y1, x2, y2) {
    ...
    if(bigElement.element) {
        ...
        var elementOffset = offset(element);
        var ide = Math.floor(Math.random()*10000)+1;
        element.setAttribute('data-auroraselector', ide);
        return {
